export interface CommonStrings {
  ...
  QUOTE_FAILED_TRY_NEXT: string,
  ALL_QUOTES_FAILED: string,
};
...
const strings: CommonStrings = {
  ...
  PRODUCTION_ENV_BANNER: `
    Extension v0.1.31 improves reliability. You will be prompted to update if you're not already on the latest version.
  `,
  ...
  // Mobile Warning
  MOBILE_WARNING_TEXT: `
    Mobile purchases are not yet supported. Please use a desktop browser for the best experience.
  `,
  ...
  // Quote failure messages
  QUOTE_FAILED_TRY_NEXT: `
    Quote failed. Please try the next available option.
  `,
  ALL_QUOTES_FAILED: `
    All available quotes have failed. Please try again later.
  `,
};
