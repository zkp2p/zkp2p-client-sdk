...
export const HYPERLIQUID_USDC_DECIMALS = 8; // Different from standard USDC (6 decimals)

// Determine which Base chain to use based on environment
const isStagingTestnet = import.meta.env.VITE_DEPLOYMENT_ENVIRONMENT === 'STAGING_TESTNET';
export const BASE_CHAIN_ID = isStagingTestnet ? BASE_SEPOLIA_CHAIN_ID : BASE_MAINNET_CHAIN_ID;

// USDC addresses
export const BASE_MAINNET_USDC_ADDRESS = '0x833589fcd6edb6e08f4c7c32d4f71b54bda02913';
export const BASE_SEPOLIA_USDC_ADDRESS = '0x17463cb89A62c7b4A5ecD949aFDEDBD0Aa047ad1';
export const BASE_USDC_ADDRESS = isStagingTestnet ? BASE_SEPOLIA_USDC_ADDRESS : BASE_MAINNET_USDC_ADDRESS;
...
export const INTENT_EXPIRATION_PERIOD_IN_SECONDS = 3600 * 6; // 6 hours

export const PRECISION = 1000000000000000000n; // 18
export const USDC_UNITS = 1000000n; // 6
export const PENNY_IN_USDC_UNITS = 10000n; // 6
...
export const DEFAULT_NETWORK = isStagingTestnet ? "base_sepolia" : "base";
