...
export const AccountDropdown = forwardRef<HTMLDivElement, AccountDropdownProps>(({ onOptionSelect }, ref) => {
  ...
  const ethBalanceDisplay = ethBalance ? `${etherUnitsToReadable(ethBalance)} ETH` : '0 ETH';
    ...
    <Wrapper>
      ...
      <NavDropdown ref={ref}>
        ...
        {isMobile && (
          <BalancesAndLogoContainer>
            ...
            <BalanceContainer>
              ...
              <BalanceValue>
                {usdcBalance ? tokenUnitsToReadable(usdcBalance, usdcInfo.decimals) : "0"}
              </BalanceValue>
            </BalanceContainer>
          </BalancesAndLogoContainer>
        )}
        ...
        <NavDropdownItemsContainer>
          ...
          {loginStatus === LoginStatus.AUTHENTICATED && activeWallet?.walletClientType === 'privy' && (
