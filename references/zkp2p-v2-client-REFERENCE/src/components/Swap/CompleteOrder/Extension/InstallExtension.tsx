...
import { ConsentInstructions } from '@components/Swap/CompleteOrder/ConsentInstructions';
...
export const InstallExtension: React.FC<InstallExtensionProps> = ({ 
  ...
  useEffect(() => {
    if (isSidebarInstalled && sideBarVersion) {
      setIsSidebarNeedsUpdate(isVersionOutdated(sideBarVersion, paymentMethod, paymentPlatform));
    }
  }, [isSidebarInstalled, sideBarVersion, paymentPlatform, paymentMethod]);
      ...
      <InstallExtensionContainer>
        {isSidebarInstalled && isSidebarNeedsUpdate ? (
          <IconAndCopyContainer>
            ...
            <ThemedText.DeprecatedBody textAlign="center">
              {commonStrings.get('EXTENSION_UPDATE_INSTRUCTIONS')}
            </ThemedText.DeprecatedBody>
