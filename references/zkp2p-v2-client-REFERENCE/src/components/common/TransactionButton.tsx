...
import { TransactionStatus, TransactionStatusType } from "@helpers/types/status/transactionStatus";
...
export const TransactionButton: React.FC<TransactionButtonProps> = ({
  ...
  return (
    <Button
      ...
      onClick={handleClick}
    >
      {(transactionStatus === TransactionStatus.TRANSACTION_LOADING || 
        transactionStatus === TransactionStatus.TRANSACTION_MINING) && (
