import{i as g,a as m,x as w}from"./lit-element-CRwiKRQV.js";import{r as u}from"./class-map-E4R2Eani.js";import{w as f,p as v,s as b,a as x}from"./index-Bcpr83TD.js";import{c as h}from"./index-Cbrxnqo_.js";const e=v({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),y={state:e,subscribe(o){return x(e,()=>o(e))},subscribeKey(o,t){return b(e,o,t)},showTooltip({message:o,triggerRect:t,variant:i}){e.open=!0,e.message=o,e.triggerRect=t,e.variant=i},hide(){e.open=!1,e.message="",e.triggerRect={width:0,height:0,top:0,left:0}}},s=f(y),R=g`
  :host {
    pointer-events: none;
  }
