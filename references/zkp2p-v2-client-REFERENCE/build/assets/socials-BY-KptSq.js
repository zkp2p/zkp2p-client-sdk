import{i as L,a as I,x as l}from"./lit-element-CRwiKRQV.js";import{n as A,r as c,o as y}from"./class-map-E4R2Eani.js";import{n as E,O as u,R as f,l as U,h as P,v as F,j as N,A as d,b as $,f as b,C as D,E as p,q as W,S as v,M as O,T as S}from"./index-Bcpr83TD.js";import{c as _}from"./index-Cbrxnqo_.js";import{O as R}from"./index-DcFEnRxk.js";import{e as j}from"./index-Bz184XhB.js";import"./index-EEwC5m0l.js";import"./index-BCkg-yGF.js";import"./index-nJjjYhNz.js";import"./index-CAPzvL6f.js";import"./index-C0eShKkt.js";import"./index-BcZx3xR5.js";import"./index-CLls0W8x.js";import"./ref-bYG6CaZp.js";import"./ConstantsUtil-Dmg8YACJ.js";import"./index-DyORczfQ.js";import"./index-BjPBTjwE.js";import"./browser-Dsxr8apA.js";const q=new AbortController,M={EmbeddedWalletAbortController:q},z=L`
  :host {
...
`;var x=function(n,e,t,o){var r=arguments.length,i=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(n,e,t,o);else for(var a=n.length-1;a>=0;a--)(s=n[a])&&(i=(r<3?s(i):r>3?s(e,t,i):s(e,t))||i);return r>3&&i&&Object.defineProperty(e,t,i),i};let m=class extends I{constructor(){super(),this.unsubscribe=[],this.tabIdx=void 0,this.connectors=E.state.connectors,this.authConnector=this.connectors.find(e=>e.type==="AUTH"),this.remoteFeatures=u.state.remoteFeatures,this.isPwaLoading=!1,this.unsubscribe.push(E.subscribeKey("connectors",e=>{this.connectors=e,this.authConnector=this.connectors.find(t=>t.type==="AUTH")}),u.subscribeKey("remoteFeatures",e=>this.remoteFeatures=e))}connectedCallback(){super.connectedCallback(),this.handlePwaFrameLoad()}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){let e=this.remoteFeatures?.socials||[];const t=!!this.authConnector,o=e?.length,r=f.state.view==="ConnectSocials";return(!t||!o)&&!r?null:(r&&!o&&(e=U.DEFAULT_SOCIALS),l` <wui-flex flexDirection="column" gap="xs">
      ${e.map(i=>l`<wui-list-social
          ...
          ></wui-list-social>`)}
    </wui-flex>`)}async onSocialClick(e){e&&await j(e)}async handlePwaFrameLoad(){if(P.isPWA()){this.isPwaLoading=!0;try{this.authConnector?.provider instanceof F&&await this.authConnector.provider.init()}catch(e){N.open({shortMessage:"Error loading embedded wallet in PWA",longMessage:e.message},"error")}finally{this.isPwaLoading=!1}}}};m.styles=z;x([A()],m.prototype,"tabIdx",void 0);x([c()],m.prototype,"connectors",void 0);x([c()],m.prototype,"authConnector",void 0);x([c()],m.prototype,"remoteFeatures",void 0);x([c()],m.prototype,"isPwaLoading",void 0);m=x([_("w3m-social-login-list")],m);const B=L`
  wui-flex {
...
`;var T=function(n,e,t,o){var r=arguments.length,i=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(n,e,t,o);else for(var a=n.length-1;a>=0;a--)(s=n[a])&&(i=(r<3?s(i):r>3?s(e,t,i):s(e,t))||i);return r>3&&i&&Object.defineProperty(e,t,i),i};let k=class extends I{constructor(){super(),this.unsubscribe=[],this.checked=R.state.isLegalCheckboxChecked,this.unsubscribe.push(R.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){const{termsConditionsUrl:e,privacyPolicyUrl:t}=u.state,o=u.state.features?.legalCheckbox,i=!!(e||t)&&!!o,s=i&&!this.checked,a=s?-1:void 0;return l`
    ...
    `}};k.styles=B;T([c()],k.prototype,"checked",void 0);k=T([_("w3m-connect-socials-view")],k);const V=L`
  wui-logo {
    width: 80px;
    height: 80px;
...
`;var C=function(n,e,t,o){var r=arguments.length,i=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(n,e,t,o);else for(var a=n.length-1;a>=0;a--)(s=n[a])&&(i=(r<3?s(i):r>3?s(e,t,i):s(e,t))||i);return r>3&&i&&Object.defineProperty(e,t,i),i};let w=class extends I{constructor(){super(),this.unsubscribe=[],this.timeout=void 0,this.socialProvider=d.state.socialProvider,this.uri=d.state.farcasterUrl,this.ready=!1,this.loading=!1,this.remoteFeatures=u.state.remoteFeatures,this.authConnector=E.getAuthConnector(),this.forceUpdate=()=>{this.requestUpdate()},this.unsubscribe.push(d.subscribeKey("farcasterUrl",e=>{e&&(this.uri=e,this.connectFarcaster())}),d.subscribeKey("socialProvider",e=>{e&&(this.socialProvider=e)}),u.subscribeKey("remoteFeatures",e=>{this.remoteFeatures=e})),window.addEventListener("resize",this.forceUpdate)}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this.timeout),window.removeEventListener("resize",this.forceUpdate)}render(){return this.onRenderProxy(),l`${this.platformTemplate()}`}platformTemplate(){return P.isMobile()?l`${this.mobileTemplate()}`:l`${this.desktopTemplate()}`}desktopTemplate(){return this.loading?l`${this.loadingTemplate()}`:l`${this.qrTemplate()}`}qrTemplate(){return l` <wui-flex
    ...
    >
      ...
      Copy link
    </wui-link>`}onCopyUri(){try{this.uri&&(P.copyToClopboard(this.uri),v.showSuccess("Link copied"))}catch{v.showError("Failed to copy")}}};w.styles=G;C([c()],w.prototype,"socialProvider",void 0);C([c()],w.prototype,"uri",void 0);C([c()],w.prototype,"ready",void 0);C([c()],w.prototype,"loading",void 0);C([c()],w.prototype,"remoteFeatures",void 0);w=C([_("w3m-connecting-farcaster-view")],w);export{k as W3mConnectSocialsView,w as W3mConnectingFarcasterView,h as W3mConnectingSocialView};
